...
// AppTheme maps all color keys to string so DarkTheme and LightTheme are both assignable
export type AppTheme = {
  readonly [K in keyof typeof DarkTheme]: K extends 'mode' ? ThemeMode : string;
};
